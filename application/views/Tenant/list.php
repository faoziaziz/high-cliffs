            ...
            <div class="modal-body">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="txtTenant" class="form-control" name="txtTenant"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="txtLocation" class="form-control" name="txtLocation"/>
                        </div>
                        <span class="help-block"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="txtPIC" class="form-control" name="txtPIC"/>
                        </div>
                        <label class="col-md-2 control-label" for="form-field-1">Phone</label>
                        <div class="col-md-4">
                            <input type="text" id="txtPhoneNumber" class="form-control" name="txtPhoneNumber">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="txtPOS" class="form-control" name="txtPOS">
                        </div>

                        <label class="col-md-2 control-label" for="form-field-1">Merk Printer</label>
                        <div class="col-md-4">
                            <input type="text" id="txtPrinter" class="form-control" name="txtPrinter">
                        </div>  
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="txtLat" class="form-control" name="txtLat">
                        </div>

                        <label class="col-md-2 control-label" for="form-field-1">Longitude</label>
                        <div class="col-md-4">
                            <input type="text" id="txtLong" class="form-control" name="txtLong">
                        </div>  
                    </div>
					<div class="form-group">
                        <label class="col-md-2 control-label" for="form-field-1">Kode</label>
                        <div class="col-md-4">
                            <input type="text" id="kodeTenant" class="form-control" name="txtKode">
                        </div>

                        <label class="col-md-2 control-label" for="form-field-1">Jenis Penjualan</label>
                        <div class="col-md-4">
                            <input type="text" id="txtJenisPenjualan" class="form-control" name="txtJenisPenjualan">
                        </div>  
					</div>
					
					<div class="form-group">
                        <label class="col-md-2 control-label" for="form-field-1">Additional</label>
                        <div class="col-md-10">
							<textarea class="form-control" name="txtAdditional"></textarea>
                        </div>  
                    </div>
                </form>
            </div>
	...
	$.ajax({
		...
		success: function(data)
		{
		   $('[name="id"]').val(data.id);
			...
			$('[name="txtKode"]').val(data.Kode);
			$('[name="txtJenisPenjualan"]').val(data.JenisPenjualan);
			$('[name="txtAdditional"]').val(data.Additional);
